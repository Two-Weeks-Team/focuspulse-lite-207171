...
Remote workers lose hours to unplanned interruptions and do not have a clear, simple way to see how many uninterrupted focus blocks they finish each day.
...
```yaml
name: focuspulse-lite
services:
  - name: api
    github:
      repo: Two-Weeks-Team/focuspulse-lite
      branch: master
